...
public class EmployeeRestControllerAspect {
	...
	private static final Logger LOG = LoggerFactory.getLogger(EmployeeRestControllerAspect.class);
	...
	@AfterReturning(value = "execution(* com.swamy.controller.EmployeeRestController.createEmployee(..))", returning = "employeeDto")
	...
	@AfterThrowing(value = "execution(* com.swamy.controller.EmployeeRestController.createEmployee(..))", throwing = "exception")
	...
	@Around(value = "execution(* com.swamy.controller.EmployeeRestController.createEmployee(..))")
